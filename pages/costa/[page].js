...
export default function Costa({ orderedItems, pages, query }) {
  ...
  const getPostItems = orderedItems?.map((item) => {
    return item.showOnWeb === true ? (
      <div onClick={setPosition} className="costa__list__item" key={item._id}>
            ...
            <div>
              <div className="costa__list__item__text">
                {item.adType.length === 1 ? (
                  <h2 className="costa__list__item__text__price">
                ...
                <h3 className="costa__list__item__text__street">
                  {item.webSubtitle}
                </h3>
          ...
          <li
            ...
            className={
              i + 1 === parseInt(splitedLocation[4])
                ? "costa__pagination__list__item currentPage"
                : "costa__pagination__list__item"
            }
          >
    ...
    <div>
      {orderedItems.length > 0 ? (
        <div>
          ...
          <div className="costa__buttons">
            <div className="costa__buttons__order">
              <p
                ...
                className="costa__buttons__order__title"
              ...
              <ul
                className={
                  orderItems === false
                    ? "costa__buttons__order__listDisabled"
                    : "costa__buttons__order__list"
                }
              >
                <li
                  onClick={onPrice}
                  style={{ cursor: "pointer" }}
                  className="costa__buttons__order__list__first"
                >
                  Precio más alto
                </li>
          ...
          <div className="costa__list">{getPostItems}</div>
          <div onClick={deletePosition} className="costa__pagination">
            <ul className="costa__pagination__list">
              {parseInt(page) !== 1 && (
                <li className="costa__pagination__list__item">
                  <a
                    className="costa__pagination__list__item__back"
              ...
              {parseInt(page) !== pagElements?.length && (
                <li className="costa__pagination__list__item">
                  <p
                    className="costa__pagination__list__item__next"
                    onClick={() => navigateToNewPath(parseInt(page) + 1, query)}
                    style={{ cursor: "pointer" }}
                  >
                    {" "}
        ...
        <div className="costa__empty">
          {
            ...
            <div className="costa__empty">
              <Header />
              <h2 className="costa__empty__text">
