...
export default function Rustico({ orderedItems, pages, query }) {
  ...
  const getPostItems = orderedItems?.map((item) => {
    return item.showOnWeb === true ? (
      <div
        onClick={setPosition}
        className="campoRustico__list__item"
        key={item._id}
      >
            ...
            <div>
              <div className="campoRustico__list__item__text">
                {item.adType.length === 1 ? (
                  <h2 className="campoRustico__list__item__text__price">
                ...
                <h2 className="campoRustico__list__item__text__title">
                  {item.title}
                </h2>
                <h3 className="campoRustico__list__item__text__street">
                  {item.webSubtitle}
                </h3>
          ...
          <li
            ...
            className={
              i + 1 === parseInt(splitedLocation[4])
                ? "campoRustico__pagination__list__item currentPage"
                : "campoRustico__pagination__list__item"
            }
          >
  ...
  function navigateToNewPath(page, query) {
    ...
    if (porfecha === undefined || porfecha === "true")
      queryFilters = { ...queryFilters, porfecha: true };
    if (porfecha === "false")
    ...
    <div>
      {orderedItems.length > 0 ? (
        <div>
          ...
          <div className="campoRustico__buttons">
            <div className="campoRustico__buttons__order">
              <p
                ...
                className="campoRustico__buttons__order__title"
              ...
              <ul
                className={
                  orderItems === false
                    ? "campoRustico__buttons__order__listDisabled"
                    : "campoRustico__buttons__order__list"
                }
              >
                <li
                  onClick={onPrice}
                  className="campoRustico__buttons__order__list__first"
                  style={{ cursor: "pointer" }}
                >
                  Precio más alto
                </li>
          ...
          <div className="campoRustico__list">{getPostItems}</div>
          <div onClick={deletePosition} className="campoRustico__pagination">
            <ul className="campoRustico__pagination__list">
              {parseInt(page) !== 1 && (
                <li className="campoRustico__pagination__list__item">
                  <a
                    className="campoRustico__pagination__list__item__back"
              ...
              {parseInt(page) !== pagElements?.length && (
                <li className="campoRustico__pagination__list__item">
                  <p
                    className="campoRustico__pagination__list__item__next"
                    onClick={() => navigateToNewPath(parseInt(page) + 1, query)}
                    style={{ cursor: "pointer" }}
                  >
                    {" "}
        ...
        <div className="campoRustico__empty">
          {
            ...
            <div className="campoRustico__empty">
              <Header />
              <h2 className="campoRustico__empty__text">
