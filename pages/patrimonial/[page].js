                            ...
                            <div className='patrimonial__filter__position'>
                                ...
                                <div className='patrimonial__filter__position__mapContainer'>
                                    <div className='patrimonial__filter__position__mapContainer__mapa'>
                                        ...
                                        className={`secu${
                                                localFilters.toString().includes("61dfdddf3e6cc4fe56c2986d")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                            <Image className='secu' src={secu} alt='componente mapa' />
                                        ...
                                        className={`plan${
                                                localFilters.toString().includes("61dfddcb3e6cc4fe56c29865")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`vald${
                                                localFilters.toString().includes("61dfddc53e6cc4fe56c29863")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`pozu${
                                                localFilters.toString().includes("61dfddcf3e6cc4fe56c29867")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`pe${
                                                localFilters.toString().includes("61dfddd53e6cc4fe56c29869")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`ctba${
                                                localFilters.toString().includes("61dfdd9d3e6cc4fe56c29853")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`cuzco${
                                                localFilters.toString().includes("61dfdd933e6cc4fe56c2984f")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`azca${
                                                localFilters.toString().includes("61dfdd883e6cc4fe56c2984d")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`cham${
                                                localFilters.toString().includes("61dfdd7e3e6cc4fe56c29849")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`alma${
                                                localFilters.toString().includes("61dfdd783e6cc4fe56c29847")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`cent${
                                                localFilters.toString().includes("61dfdd6d3e6cc4fe56c29843")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`meal${
                                                localFilters.toString().includes("61dfdd623e6cc4fe56c2983f")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`juca${
                                                localFilters.toString().includes("61dfddc13e6cc4fe56c29861")
                                                    ? " active"
                                                    : ""
                                                }`} >
                                        ...
                                        className={`amer${
                                                localFilters.toString().includes("61dfddb23e6cc4fe56c2985b")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`jova${
                                                localFilters.toString().includes("61dfddb73e6cc4fe56c2985d")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`chama${
                                                localFilters.toString().includes("61dfdd983e6cc4fe56c29851")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`arso${
                                                localFilters.toString().includes("61dfddbc3e6cc4fe56c2985f")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`cana${
                                                localFilters.toString().includes("61dfdda73e6cc4fe56c29857")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`sanchi${
                                                localFilters.toString().includes("61dfdda23e6cc4fe56c29855")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`arva${
                                                localFilters.toString().includes("61dfddac3e6cc4fe56c29859")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`viso${
                                                localFilters.toString().includes("61dfdd833e6cc4fe56c2984b")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`sala${
                                                localFilters.toString().includes("61dfdd733e6cc4fe56c29845")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        className={`jero${
                                                localFilters.toString().includes("61dfdd673e6cc4fe56c29841")
                                                    ? " active"
                                                    : ""
                                                }`}>
