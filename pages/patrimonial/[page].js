...
export default function Patrimonial({ orderedItems, pages, query, queryFilters }) {
    ...
    const { tipo, tipodeinmueble, referencia, zona, exclusivooficinas, clasico, coworking, porfecha, page } = query
    ...
    if (exclusivooficinas !== undefined) URLwithoutPage.push(`exclusivooficinas=${exclusivooficinas}`)
                            ...
                            <div className='patrimonial__list__item__text'>
                                ...
                                <ul className='patrimonial__list__item__text__characteristics'>
                                    ...
                                    {item.quality.jobPositions !== 0 ?
                                        <li><span><Image width={15} height={12} src={job} alt='puestos de trabajo' /></span>{item.quality.jobPositions}</li>
                                        : null}
                                    {item.quality.parking !== 0 ?
                                        <li className='patrimonial__list__item__text__characteristics__car'><span><Image width={21} height={12} src={parking} alt='plazas parking' /></span>{item.quality.parking}</li>
                                        : null}
                                    {item.adReference !== 0 ?
    ...
    useEffect(() => {
        let extrasLocal = [];
        if (localFilters.includes('exclusiveOfficeBuilding')) extrasLocal = [...extrasLocal, 'exclusiveOfficeBuilding']
        if (localFilters.includes('classicBuilding')) extrasLocal = [...extrasLocal, 'classicBuilding']
        if (localFilters.includes('coworking')) extrasLocal = [...extrasLocal, 'coworking']
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < pageCount; i++) {
            if (URLwithoutPage.length !== 0) {
                ...
                elements.push(
                    <li key={i} className={i + 1 === parseInt(splitedLocation[4]) ? 'patrimonial__pagination__list__item currentPage' : 'patrimonial__pagination__list__item'}><a href={`/patrimonial/${i + 1}?${URL}&page=${i + 1}`}>{i + 1}</a></li>
                )
            } else {
                elements.push(
                    <li key={i} className={i + 1 === parseInt(splitedLocation[4]) ? 'patrimonial__pagination__list__item currentPage' : 'patrimonial__pagination__list__item'}><a href={`/patrimonial/${i + 1}?page=${i + 1}`}>{i + 1}</a></li>
                )
            }
    ...
    const onPrice = () => {
        setIsLoading(false)
        if (typeof window !== 'undefined') {
            let activeFilters = JSON.parse(window.localStorage.getItem('patrimonialFilters'));
    ...
    function navigateToNewPath(page, query) {
        const { tipo, tipodeinmueble, referencia, zona, exclusivooficinas, clasico, coworking, porfecha, precioventamax, precioventamin, precioalquilermax, precioalquilermin, superficiemin, superficiemax } = query
        ...
        if (exclusivooficinas !== undefined) queryFilters = { ...queryFilters, exclusivooficinas: true }
        if (clasico !== undefined) queryFilters = { ...queryFilters, clasico: true }
        if (coworking !== undefined) queryFilters = { ...queryFilters, coworking: true }
                ...
                <div>
                    {filter === true ?
                        <div className='patrimonial__filter'>
                            <div className='patrimonial__filter__position'>
                                <h2 className='patrimonial__filter__title'>Zonas <span onClick={toggleFilter}><Image width={14} height={14} src={cerrarFiltro} alt='cerrar' /></span></h2>
                                <h3 className='patrimonial__filter__subTitle'>Seleccione una o varias zonas</h3>
                                <div className='patrimonial__remove'>
                                    <button onClick={removeFilterOptions} className='patrimonial__buttons__remove__filters' style={{ cursor: "pointer" }}><Image width={9} height={9} src={cerrarFiltro} alt='boton borrar filtro' /> Borrar filtros</button>
                                </div>
                                <div className='patrimonial__filter__position__mapContainer'>
                                    <div className='patrimonial__filter__position__mapContainer__mapa'>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Madrid Secundario' id='secu'
                                            className={`secu${localFilters.toString().includes("61dfdddf3e6cc4fe56c2986d")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                            <Image className='secu' src={secu} alt='componente mapa' />
                                        ...
                                        <button name='El Plantio' onClick={!getMaxPrices ? toggleActive : null} id='plan'
                                            className={`plan${localFilters.toString().includes("61dfddcb3e6cc4fe56c29865")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button type='image' onClick={!getMaxPrices ? toggleActive : null} name='Valdemarin' id='vald'
                                            className={`vald${localFilters.toString().includes("61dfddc53e6cc4fe56c29863")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Pozuelo' id='pozu'
                                            className={`pozu${localFilters.toString().includes("61dfddcf3e6cc4fe56c29867")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='PE La Finca' id='pe'
                                            className={`pe${localFilters.toString().includes("61dfddd53e6cc4fe56c29869")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='CTBA' id='ctba'
                                            className={`ctba${localFilters.toString().includes("61dfdd9d3e6cc4fe56c29853")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Cuzco' id='cuzco'
                                            className={`cuzco${localFilters.toString().includes("61dfdd933e6cc4fe56c2984f")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Azca' id='azca'
                                            className={`azca${localFilters.toString().includes("61dfdd883e6cc4fe56c2984d")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Chamberi' id='cham'
                                            className={`cham${localFilters.toString().includes("61dfdd7e3e6cc4fe56c29849")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Almagro' id='alma'
                                            className={`alma${localFilters.toString().includes("61dfdd783e6cc4fe56c29847")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Centro' id='cent'
                                            className={`cent${localFilters.toString().includes("61dfdd6d3e6cc4fe56c29843")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Mendez Alvaro' id='meal'
                                            className={`meal${localFilters.toString().includes("61dfdd623e6cc4fe56c2983f")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Julian Camarillo' id='juca'
                                            className={`juca${localFilters.toString().includes("61dfddc13e6cc4fe56c29861")
                                                    ? " active"
                                                    : ""
                                                }`} >
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Av. America' id='amer'
                                            className={`amer${localFilters.toString().includes("61dfddb23e6cc4fe56c2985b")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Josefa Valcarcel' id='jova'
                                            className={`jova${localFilters.toString().includes("61dfddb73e6cc4fe56c2985d")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Chamartin' id='chama'
                                            className={`chama${localFilters.toString().includes("61dfdd983e6cc4fe56c29851")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Arturo Soria' id='arso'
                                            className={`arso${localFilters.toString().includes("61dfddbc3e6cc4fe56c2985f")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Campos de las Naciones' id='cana'
                                            className={`cana${localFilters.toString().includes("61dfdda73e6cc4fe56c29857")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Las Tablas - San Chinarro' id='sanchi'
                                            className={`sanchi${localFilters.toString().includes("61dfdda23e6cc4fe56c29855")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Arroyo de la Vega' id='arva'
                                            className={`arva${localFilters.toString().includes("61dfddac3e6cc4fe56c29859")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='El Viso' id='viso'
                                            className={`viso${localFilters.toString().includes("61dfdd833e6cc4fe56c2984b")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Barrio Salamanca' id='sala'
                                            className={`sala${localFilters.toString().includes("61dfdd733e6cc4fe56c29845")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                        ...
                                        <button onClick={!getMaxPrices ? toggleActive : null} name='Jeronimos' id='jero'
                                            className={`jero${localFilters.toString().includes("61dfdd673e6cc4fe56c29841")
                                                    ? " active"
                                                    : ""
                                                }`}>
                                ...
                                <div className='patrimonial__filter__selectors'>
                                    ...
                                    <div className='patrimonial__filter__selectors__tipo'>
                                        ...
                                        <div className='patrimonial__filter__selectors__tipo__buttons'>
                                            <button onClick={addType} name='Oficina' id='oficina'
                                                className={`oficina${localFilters.toString().includes("Oficina")
                                                        ? " activeButton"
                                                        : ""
                                                    }`}>Oficina</button>
                                            <button onClick={addType} name='Edificio' id='edificio'
                                                className={`edificio${localFilters.toString().includes("Edificio")
                                                        ? " activeButton"
                                                        : ""
                                                    }`}>Edificio</button>
                                            <button onClick={addType} name='Local' id='retail'
                                                className={`retail${localFilters.toString().includes("Local")
                                                        ? " activeButton"
                                                        : ""
                                                    }`}>Local</button>
                                        </div>
                                    ...
                                    <div className='patrimonial__filter__selectors__tipo'>
                                        <h3>Extras</h3>
                                        <div className='patrimonial__filter__selectors__tipo__buttons'>
                                            <button onClick={addExtra} name='exclusiveOfficeBuilding' id='exclusiveOfficeBuilding'
                                                className={`exclusiveOfficeBuilding${localFilters.toString().includes("exclusiveOfficeBuilding")
                                                    ? " activeButton"
                                                    : ""
                                                    }`}>Exclusivo oficinas</button>
                                            <button onClick={addExtra} name='classicBuilding' id='classicBuilding'
                                                className={`classicBuilding${localFilters.toString().includes("classicBuilding")
                                                    ? " activeButton"
                                                    : ""
                                                    }`}>Edificio clásico</button>
                                            <button onClick={addExtra} name='coworking' id='coworking'
                                                className={`coworking${localFilters.toString().includes("coworking")
                                                        ? " activeButton"
                                                        : ""
                                                    }`}>Coworking</button>
                                        </div>
                                    ...
                                    <div className='patrimonial__filter__selectors__sliders'>
                                        ...
                                        {disableSliders ?
                                            ...
                                            <PricesSliders
                                                ...
                                                valueLabelFormat={saleOrRent[0] === 'Venta' ? value => `${new Intl.NumberFormat('de-DE').format(value)} €` : value => `${new Intl.NumberFormat('de-DE').format(value)} €/mes`}
                                            />}
                                        <p className='patrimonial__filter__selectors__sliders__surface'>Superficie m<sup>2</sup></p>
                                        <PricesSliders
                                            className={'patrimonial__filter__selectors__sliders__surface'}
                                            getAriaLabel={() => 'Minimum distance'}
                                            value={surface}
                                    ...
                                    <div className='patrimonial__filter__selectors__buscar'>
                                        {disableButton === false ?
                                            <button onClick={() => getTypeHouse()} className='patrimonial__filter__selectors__buscar__all' >Ver todos</button>
                                            :
                                            <button className='patrimonial__filter__selectors__buscar__allDisabled'>Ver todos</button>
                                        }
                                        {disableButton === true ?
                                            <button className='patrimonial__filter__selectors__buscar__search'
                                    ...
                                    <div className='patrimonial__filter__selectors__ref'>
                                        ...
                                        <Image width={17} height={17} className={verLupa === true ? 'patrimonial__filter__selectors__ref__lupa' : 'patrimonial__filter__selectors__ref__lupaOculta'} src={lupa} alt='lupa' />
                    ...
                    <div onClick={deletePosition} className='patrimonial__pagination'>
                        <ul className='patrimonial__pagination__list'>
                            {parseInt(page) !== 1 && <li className='patrimonial__pagination__list__item'><a className='patrimonial__pagination__list__item__back' onClick={() => navigateToNewPath(parseInt(page) - 1, query)} style={{ cursor: "pointer" }}> <Image width={8} height={10} src={mayor} alt='simbolo mayor' /> </a></li>}
                            {arrPages.map((__pag, i) => {
                                return <li key={i} className={i + 1 === parseInt(page) ? 'patrimonial__pagination__list__item currentPage' : 'patrimonial__pagination__list__item'}><p onClick={() => navigateToNewPath(i + 1, query)} style={{ cursor: "pointer" }}>{i + 1}</p></li>

                            })}
                            {parseInt(page) !== pagElements?.length && <li className='patrimonial__pagination__list__item'><p className='patrimonial__pagination__list__item__next' onClick={() => navigateToNewPath(parseInt(page) + 1, query)} style={{ cursor: "pointer" }}> <Image width={8} height={10} src={mayor} alt='simbolo menor' /> </p></li>}
                        </ul>
                    </div>
                    <div className='patrimonial__zoneMap'>
                        <Link href={routes.FilterPatrimonial} className='patrimonial__zoneMap__button'><span><Image src={zoneMap} alt='boton mapa' /></span> Abrir el mapa de zonas</Link>
                    </div>
                    <ContactIndex />
                </div>
                :
                <div className='patrimonial__empty'>
                    {
                        ...
                        (
                            <div className='patrimonial__empty'>
                                ...
                                <Link className='patrimonial__empty__button' href={`${routes.FilterPatrimonial}`}>Volver al mapa</Link>
                            </div>
                        )
                        //    :
...
export async function getServerSideProps(context) {
    ...
    // console.log(query)
    const { tipo, tipodeinmueble, referencia, zona, exclusivooficinas, clasico, coworking, page, porfecha, precioventamax, precioventamin, precioalquilermax, precioalquilermin, superficiemin, superficiemax } = context.query
    ...
    if (exclusivooficinas !== undefined) queryFilters = { ...queryFilters, garage: true }
    if (clasico !== undefined) queryFilters = { ...queryFilters, swimmingPool: true }
    if (coworking !== undefined) queryFilters = { ...queryFilters, terrace: true }
