            ...
            <div className='equipo__owners'>
                {consultants.map(consultant=> 
                    ...
                    <div key={consultant.fullName} className='equipo__owners__owner'>
                        <Image width={250} height={170} src={consultant.avatar ? consultant.avatar : gvreLogo} alt={consultant.fullName}/>
                        <h3>{consultant.fullName}</h3>
                        <a href={`mailto:${consultant.consultantEmail}`}><h4 >{consultant.consultantEmail}</h4></a>
                    </div>:null
