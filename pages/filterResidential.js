...
export default function FilterResidential() {
  ...
  return (
    <div className="filtroResidencial">
      ...
      <h3 className="filtroResidencial__subTitle">
      ...
      <div className="filterPosition">
        <div className="filterPosition__mapContainer">
          <div className="mapa">
            ...
            />
            <Image
              width={size >= 1350 ? 262 * 1.54 : 262 * 1.6}
              height={size >= 1350 ? 70 * 1.53 : 63 * 1.1}
              className="c2"
              src={carretera2}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 466 * 1.54 : 466 * 1.6}
              height={size >= 1350 ? 352 * 1.53 : 316 * 1.1}
              className="c3"
              src={carretera3}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 97 * 1.54 : 97 * 1.6}
              height={size >= 1350 ? 60 * 1.53 : 54 * 1.1}
              className="c4"
              src={carretera4}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 166 * 1.54 : 166 * 1.6}
              height={size >= 1350 ? 77 * 1.53 : 70 * 1.1}
              className="c5"
              src={carretera5}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 15 * 1.54 : 15 * 1.6}
              height={size >= 1350 ? 176 * 1.53 : 158 * 1.1}
              className="c6"
              src={carretera6}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 8 * 1.54 : 8 * 1.6}
              height={size >= 1350 ? 26 * 1.53 : 23 * 1.1}
              className="c62"
              src={carretera62}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 86 * 1.54 : 86 * 1.6}
              height={size >= 1350 ? 12 * 1.53 : 11 * 1.1}
              className="c7"
              src={carretera7}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 97 * 1.54 : 97 * 1.6}
              height={size >= 1350 ? 54 * 1.53 : 49 * 1.1}
              className="c8"
              src={carretera8}
              alt="componente mapa"
            />
        ...
        <div className="selectors">
          ...
          <div className="selectors__buscar">
            ...
            {disableButton === false ? (
              <button
                ...
                className="selectors__buscar__all"
              >
                Ver todos
              </button>
            ) : (
              <button className="selectors__buscar__allDisabled">
                Ver todos
              </button>
            )}
            {disableButton === true ? (
               ...
               */
              <button
                className="selectors__buscar__search"
                onClick={filterResults}
              ...
              <button className="selectors__buscar__searchDisabled">
                Buscar
              </button>
            )}
          </div>
          <div className="selectors__ref">
            ...
            <Image
              className={
                verLupa === true
                  ? "selectors__ref__lupa"
                  : "selectors__ref__lupaOculta"
              }
              src={lupa}
              alt="lupa"
            />
