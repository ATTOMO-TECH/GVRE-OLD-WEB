...
export default function Singular({ orderedItems, pages, query }) {
  ...
  const getPostItems = orderedItems?.map((item) => {
    return item.showOnWeb === true ? (
      <div
        onClick={setPosition}
        className="singular__list__item"
        key={item._id}
      >
            ...
            <div>
              <div className="singular__list__item__text">
                {item.adType.length === 1 ? (
                  <h2 className="singular__list__item__text__price">
                ...
                <h2 className="singular__list__item__text__title">
                  {item.title}
                </h2>
                <h3 className="singular__list__item__text__street">
                  {item.webSubtitle}
                </h3>
            ...
            <li
              ...
              className={
                i + 1 === parseInt(splitedLocation[4])
                  ? "singular__pagination__list__item currentPage"
                  : "singular__pagination__list__item"
              }
            >
    ...
    <div className="singular">
      {orderedItems.length > 0 ? (
        <div>
          ...
          <div className="singular__buttons">
            <div className="singular__buttons__order">
              <p
                ...
                className="singular__buttons__order__title"
              ...
              <ul
                className={
                  orderItems === false
                    ? "singular__buttons__order__listDisabled"
                    : "singular__buttons__order__list"
                }
              >
                <li
                  onClick={onPrice}
                  className="singular__buttons__order__list__first"
                  style={{ cursor: "pointer" }}
                >
                  Precio más alto
                </li>
          ...
          <div className="singular__list">{getPostItems}</div>
          <div onClick={deletePosition} className="singular__pagination">
            <ul className="singular__pagination__list">
              {parseInt(page) !== 1 && (
                <li className="singular__pagination__list__item">
                  <a
                    className="singular__pagination__list__item__back"
              ...
              {parseInt(page) !== pagElements?.length && (
                <li className="singular__pagination__list__item">
                  <p
                    className="singular__pagination__list__item__next"
                    onClick={() => navigateToNewPath(parseInt(page) + 1, query)}
                    style={{ cursor: "pointer" }}
                  >
                    {" "}
        ...
        <div className="singular__empty">
          {
            ...
            <div className="singular__empty">
              <Header />
              <h2 className="singular__empty__text">
