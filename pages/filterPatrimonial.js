...
export default function FilterPatrimonial() {
  ...
  return (
    <div className="filtroPatrimonio">
      ...
      <h3 className="filtroPatrimonio__subTitle">
      ...
      <div className="filtroPatrimonio__filterPosition">
        <div className="filtroPatrimonio__filterPosition__mapContainer">
          <div className="filtroPatrimonio__filterPosition__mapContainer__mapa">
            <Image
              width={size >= 1350 ? 720 : 536}
              height={size >= 1350 ? 526 : 392}
              className="c1"
              src={carretera1}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 352 : 262}
              height={size >= 1350 ? 95 : 71}
              className="c2"
              src={carretera2}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 626 : 466}
              height={size >= 1350 ? 473 : 352}
              className="c3"
              src={carretera3}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 130 : 96}
              height={size >= 1350 ? 80 : 60}
              className="c4"
              src={carretera4}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 223 : 166}
              height={size >= 1350 ? 103 : 77}
              className="c5"
              src={carretera5}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 19 : 15}
              height={size >= 1350 ? 236 : 176}
              className="c6"
              src={carretera6}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 11 : 8}
              height={size >= 1350 ? 35 : 26}
              className="c62"
              src={carretera62}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 115 : 86}
              height={size >= 1350 ? 16 : 12}
              className="c7"
              src={carretera7}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 130 : 96}
              height={size >= 1350 ? 73 : 54}
              className="c8"
              src={carretera8}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 108 : 80}
              height={size >= 1350 ? 120 : 89}
              className="c9"
              src={carretera9}
              alt="componente mapa"
            />
            <Image
              width={size >= 1350 ? 93 : 70}
              height={size >= 1350 ? 55 : 41}
              className="c10"
              src={carretera10}
              alt="componente mapa"
            />
            ...
            <button
              onClick={!getMaxPrices ? toggleActive : null}
              name="CTBA (Cuatro torres business area)"
              id="ctba"
              className="ctba"
            >
        ...
        <div className="filtroPatrimonio__filterPosition__selectors">
          ...
          <div className="filtroPatrimonio__filterPosition__selectors__sliders">
              ...
              <PricesSliders
                ...
                valueLabelFormat={
                  saleOrRent[0] === "Venta"
                    ...
                    : (value) =>
                        `${new Intl.NumberFormat("de-DE").format(value)} €/mes`
                }
              />
            ) : (
              <PricesSliders
            ...
            <p
              className={
                "filtroPatrimonio__filterPosition__selectors__sliders__surface"
              }
            >
          ...
          <div className="filtroPatrimonio__filterPosition__selectors__buscar">
            {disableButton === false ? (
              <button
                ...
                className="filtroPatrimonio__filterPosition__selectors__buscar__all"
                href={`${routes.Patrimonial}/1`}
              >
                Ver todos
              </button>
            ) : (
              <button className="filtroPatrimonio__filterPosition__selectors__buscar__allDisabled">
                Ver todos
              </button>
            )}
            {disableButton === true ? (
              <button
                className="filtroPatrimonio__filterPosition__selectors__buscar__search"
                onClick={filterResults}
                href={`${routes.Patrimonial}/1`}
              >
                Buscar
              ...
              <button className="filtroPatrimonio__filterPosition__selectors__buscar__searchDisabled">
                Buscar
              </button>
            )}
          </div>
          <div className="filtroPatrimonio__filterPosition__selectors__ref">
            ...
            <input onKeyDown={handleOnKeyEnter} onChange={addRef} type="text" />
            <Image
              className={
                verLupa === true
                  ? "filtroPatrimonio__filterPosition__selectors__ref__lupa"
                  : "filtroPatrimonio__filterPosition__selectors__ref__lupaOculta"
              }
              src={lupa}
              alt="lupa"
            />
