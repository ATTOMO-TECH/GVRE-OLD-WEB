    ...
    <header>
      <div className="header">
        ...
        <div className="header__menu">
          <span onClick={toggleClass} className="header__menu__burguer">
            <Image width={28} height={20} src={menuHam} alt="menu" />
          </span>
          <ul
            className={
              isActive
                ? "notVisibleMenu header__menu__list"
                : "header__menu__list"
            }
          >
            <Image
              ...
              width={14}
              height={14}
              className="header__menu__list__close"
              src={cerrarFiltro}
              alt="cerrar"
            />
            <li className="header__menu__list__home">
