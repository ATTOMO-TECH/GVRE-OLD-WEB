...
export default function FullScreenPDF({catalogNumber, displayFullScren, setDisplayFullScren}){
    return (
        <Dialog 
        id='catalogModal' 
        ...
        blockScroll={true}
        >
       <CatalogPDF catalogNumber={catalogNumber} setDisplayFullScren={setDisplayFullScren}/>
    </Dialog>
    )
}