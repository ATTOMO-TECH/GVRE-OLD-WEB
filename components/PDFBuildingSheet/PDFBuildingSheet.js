...
export function BuildingSheetPDF({ qrCode, state, consultant }) {
  ...
  function getQualities(qualities, department) {
    ...
    if (qualities.separateEntrance)
      printQualities.push("Entrada independiente");
    if (qualities.exclusiveOfficeBuilding)
      printQualities.push("Edificio exclusivo de oficinas");
    ...
    <Document>
      ...
      >
            ...
            {state.adType.length === 2 ? (
              <Text style={{ fontSize: "18px" }}>
                {state?.sale?.saleValue
                  ? `${separateDecimal(state?.sale?.saleValue)} €`
                  : null}
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{" "}
                {state?.rent?.rentValue
                  ? `${separateDecimal(state?.rent?.rentValue)} €/mes`
                  : null}
              </Text>
            ) : (
              <Text style={{ fontSize: "18px" }}>
        ...
        {(state.department === "Patrimonio" &&
          ...
          state.adType[0] === "Venta" &&
          state.ibi.ibiShowOnWeb &&
          state.ibi.ibiValue !== 0) ||
        (state.department === "Patrimonio" &&
          state.adType.length === 1 &&
          state.adType[0] === "Venta" &&
          state.communityExpenses.expensesShowOnWeb &&
        ...
        (state.department === "Patrimonio" &&
          ...
          >
            ...
            state.adType.length === 1 &&
            state.adType[0] === "Venta" &&
            state.trashFee.trashFeeShowOnWeb &&
            typeof state.trashFee?.trashFeeValue === Number &&
            ...
            state.expenses !== 0 ? (
              ...
              >
                ...
                >
                  ...
                  >
                    {`${new Intl.NumberFormat("de-DE").format(state.expenses)}`}{" "}
                  </Text>
                  <Text
                    style={{
                      fontSize: "9px",
            ...
            {qualities?.map((quality, i) => (
              ...
              >
                <Image
                  ...
                  src="https://gvre-images.fra1.digitaloceanspaces.com/check.png"
                  alt="check"
                />
        ...
        >
          ...
          >
            ...
            >
              {consultant !== undefined ? consultant.fullName : "GV Retail"}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            ...
            >
              <Image
                ...
                src="https://gvre-images.fra1.digitaloceanspaces.com/map-pin-icon.png"
                alt="map icon"
              />
              <Text
                style={{
              ...
              >
                {consultant !== undefined ? consultant.office1 : "Lagasca 36"}{" "}
                {consultant !== undefined && consultant.office2 !== ""
                  ? `| ${consultant.office2}`
                  : null}
              </Text>
            </View>
            ...
            >
              <Image
                style={{ width: "10px", height: "10px" }}
                src="https://gvre-images.fra1.digitaloceanspaces.com/phone-icon.png"
                alt="phone icon"
              />
              <Text
                style={{
              ...
              >
                {consultant !== undefined
                  ...
                  : "917 365 385"}{" "}
                {consultant !== undefined &&
                consultant.consultantPhoneNumber !== ""
                  ? `| ${consultant.consultantPhoneNumber}`
                  : null}
              </Text>
            </View>
            ...
            >
              <Image
                style={{ width: "10px", height: "10px" }}
                src="https://gvre-images.fra1.digitaloceanspaces.com/mail-icon.png"
                alt="mail icon"
              />
              <Text
                style={{
        ...
        >
          *Datos orientativos facilitados por la propiedad. Información sin
...
export default function DownloadSheet({ dataURL, state, currentConsultant }) {
  ...
  return (
    <PDFDownloadLink
      document={
        <BuildingSheetPDF state={state} consultant={currentConsultant} />
      }
      fileName={`Ficha ${state.title}`}
    >
