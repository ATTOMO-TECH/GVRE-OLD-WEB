...
export default function CatalogPDF({
  ...
  function changeZoom(offSet) {
    if (zoomNumber >= 1 && zoomNumber <= 1.3)
      setZoomNumber(zoomNumber + offSet);
  }
  ...
  return (
    <div className="container__pdf">
      <div className="container__pdf__data">
        {pageNumber > 1 && (
          <Image
            ...
            src={
              displayFullScren === false
                ? "/SVG/left-arrow.svg"
                : "/SVG/left-arrowDark.svg"
            }
            alt=""
          />
        )}
        <div id="documentPDF" className="container__pdf__data__viewer">
          <Document
            ...
            file={catalogs[catalogNumber]?.catalog}
          ...
          >
            ...
            <div className={`scroll${zoomNumber}`}>
              {catalogNumber === 0 ? null : size >= 1000 &&
                pageNumber !== 1 &&
                pageNumber < numPages ? (
                <Page
                  height={displayFullScren === false ? 625 : 625}
      ...
      >
        <p className="container__pdf__options__pages">
          {" "}
          {pageNumber} / {numPages}{" "}
        </p>
        <PricesSliders
        ...
        {displayFullScren === false ? (
          <BsFullscreen
            onClick={() => setDisplayFullScren(true)}
            style={
              size > 400
                ? { fontSize: "35px", margin: "3px 0px", cursor: "pointer" }
                : { fontSize: "50px", margin: "3px 0px", cursor: "pointer" }
            }
          />
        ) : null}
      </div>
