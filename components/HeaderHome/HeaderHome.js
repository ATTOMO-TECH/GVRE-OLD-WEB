    ...
    <header>
      <div className="headerHome">
        ...
        <div className="headerHome__menu">
          <span onClick={toggleClass} className="headerHome__menu__burguer">
            <Image src={menuHam} alt="menu" />
          </span>
          <ul
            className={
              isActive
                ? "notVisibleMenu headerHome__menu__list"
                : "headerHome__menu__list"
            }
          >
            <Image
              onClick={toggleClass}
              className="headerHome__menu__list__close"
              src={cerrarFiltro}
              alt="cerrar"
            />
            <li className="headerHome__menu__list__home">
              <Link onClick={toggleClass} href={routes.Home}>
                Home
              </Link>
            </li>
            <li>
              <Link onClick={toggleClass} href={routes.FilterResidential}>
                Residencial
              </Link>
            </li>
            <li>
              <Link onClick={toggleClass} href={routes.FilterPatrimonial}>
                Patrimonio
              </Link>
            </li>
            <li className="headerHome__menu__list__GV">
              <div className="headerHome__menu__list__GV__name">
                ...
                <ul className="headerHome__menu__list__GV__name__menu">
                  ...
                  <li>
                    <Link onClick={toggleClass} href={routes.Contextual}>
                      Comercialización
                    </Link>
                  </li>
                  <li>
                    <Link
                      onClick={toggleClass && situate}
                      href={`${routes.Contextual}#inversion`}
                    >
                      Inversión
                    </Link>
                  </li>
                  <li>
                    <Link
                      onClick={toggleClass && situate2}
                      href={`${routes.Contextual}#gestion`}
                    >
                      Gestión patrimonial
                    </Link>
                  </li>
            ...
            <li className="headerHome__menu__list__contact">
