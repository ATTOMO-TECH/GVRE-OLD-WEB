            ...
            <div className='headerHome'>
                ...
                <div className='headerHome__menu'>
                    ...
                    <ul className={isActive ? "notVisibleMenu headerHome__menu__list" : 'headerHome__menu__list'}>
                        <Image onClick={toggleClass} className='headerHome__menu__list__close' src={cerrarFiltro} alt='cerrar'/>
                        <li className='headerHome__menu__list__home'><Link onClick={toggleClass} href={routes.Home}>Home</Link></li>
